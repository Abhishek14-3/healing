...
import { getUserProfile, saveUserProfile, UserProfile, DEFAULT_PROFILE } from '@/lib/user-profile';
              ...
              <div className="mb-6">
                <div className="text-center mb-4">
                  <div className="font-heading text-5xl font-bold text-foreground">
                    {(currentValue as number) ?? DEFAULT_PROFILE[step.key as keyof typeof DEFAULT_PROFILE]}
                  </div>
                ...
                <input
                  ...
                  min={step.min}
                  max={step.max}
                  value={(currentValue as number) ?? DEFAULT_PROFILE[step.key as keyof typeof DEFAULT_PROFILE] as number}
