...
const DASHBOARD_GREETING: Record<string, string> = {
  direct: "Here's where things stand today.",
  playful: "Hey you ✨ — let's see how today's shaping up!",
  analytical: 'A reflective look at your week so far.',
  gentle: "Here's your wellness reflection for today.",
};
      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="text-muted-foreground">
            {DASHBOARD_GREETING[profile.supportPreference ?? 'gentle']}
          </p>
        </motion.div>
